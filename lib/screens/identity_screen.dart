  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: identityAsync.when(
        ...
        error: (e, _) => Center(child: Text("Error loading identity: $e", style: const TextStyle(color: Colors.red))),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    // FIX: Display FULL key with wrapping, monospace font
                    SelectableText(
                      myId,
                  ...
                  Expanded(
                    child: InkWell(
                      onTap: () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Full Identity Copied")));
                      },
                      child: Container(
                        height: 60,
                        decoration: BoxDecoration(color: const Color(0xFF15151F), borderRadius: BorderRadius.circular(16), border: Border.all(color: Colors.white12)),
                        child: const Center(child: Icon(UniconsLine.copy, color: Colors.white))
                      ),
                    ),
                  ),
                  ...
                  Expanded(
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        child: const Center(child: Icon(UniconsLine.share_alt, color: Colors.white))
                      ),
                    ),
                  ),
                ],
